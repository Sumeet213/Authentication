...
- Passport JWT Strategy Boilerplate
- Passport Google Strategy Boilerplate

## clone or download
```terminal
$ git clone https://github.com/Sumeet213/Authentication
$ npm i
```
...
```terminal
$ cd Authentication   // go to project folder
